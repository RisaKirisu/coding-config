...
- After exiting plan mode, compress exploration context during planning. However, reload loaded skills and the plan file itself immediatly after compression before starting the implementation.
...
- The pattern should not be overly specific
