...
- [x] Concurrent multiline Project Log appends are written as one entry, log tails contain only complete lines, terminal control sequences are removed, reset-only lines are omitted, and ingress lines retain their original timestamps.
